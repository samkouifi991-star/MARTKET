// Temporary, one-off automation for Phase F economic-data seeding via the
// real Admin Data Entry form (not a new ingestion path — see AGENTS.md
// session notes). Deleted after use; not part of the shipped app.
const { chromium } = require("playwright");
const fs = require("fs");
const path = require("path");

const BASE = process.env.SEED_BASE_URL || "https://martket-nine.vercel.app";
const QA_EMAIL = process.env.SEED_QA_EMAIL;
